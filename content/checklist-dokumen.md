...
- [ ] Form **DS-2019** asli
- [ ] Bukti bayar **SEVIS I-901**
- [ ] Surat penerimaan (LoA) UCR — cetak
- [ ] SK Beasiswa PKUMI-LPDP — cetak
- [ ] Kontrak/perjanjian beasiswa LPDP — cetak
...
- [ ] DS-2019 & SEVIS fee lunas
- [ ] Tiket pesawat PP terbit
- [ ] Asuransi aktif (tanggal mulai ≤ tanggal keberangkatan)
- [ ] Vaksinasi sesuai syarat UCR/California lengkap
...
| Nama | No. HP/WA | Kontak darurat | Housing di Riverside |
|---|---|---|---|
| ⬜ (kamu) | | | |
| ⬜ | | | |
| ⬜ | | | |
...
- [ ] Simpan alamat akomodasi final (update ke ISSO bila alamat berubah dari yang didaftarkan visa)
